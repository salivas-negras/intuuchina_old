CREATE TABLE IF NOT EXISTS `#__tst_jglist_static_country` (
...
INSERT INTO `#__tst_jglist_static_country` (`id`, `code`, `country`) VALUES
(1, 'AF', 'Afghanistan'),
(2, 'AX', 'Aland Islands Ãland Islands'),
(3, 'AL', 'Albania'),
(4, 'DZ', 'Algeria'),
(5, 'AS', 'American Samoa'),
(6, 'AD', 'Andorra'),
...
(52, 'CK', 'Cook Islands'),
(53, 'CR', 'Costa Rica'),
(54, 'CI', 'Cote d\'Ivoire CÃ´te d\'voire'),
(55, 'HR', 'Croatia'),
(56, 'CU', 'Cuba'),
(57, 'CY', 'Cyprus'),
