			...
			<form action="<?php echo r_('index.php?ext=chronoforms&act=save_settings'); ?>" method="post" name="admin_form" id="admin_form">
				...
				<div class="tab-content">
					<div id="emails" class="tab-pane active">
						...
						<?php echo $this->Html->formLine('Chronoforms[mail][mail_method]', array('type' => 'dropdown', 'label' => l_('CF_MAILING_METHOD'), 'values' => (!empty($this->data['Chronoforms']['mail']['smtp']) ? 'smtp' : 'phpmail'), 'options' => array('phpmail' => l_('PHP Mailer'), 'sendmail' => l_('SENDMAIL'), 'smtp' => l_('SMTP'), 'joomla' => 'Joomla'))); ?>
