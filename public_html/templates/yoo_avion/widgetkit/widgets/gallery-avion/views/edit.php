    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-overlay" class="uk-form-width-medium" ng-model="widget.data['overlay']">
                            <option value="full">{{'Overlay Full' | trans}}</option>
                            <option value="bottom">{{'Overlay Bottom' | trans}}</option>
                        </select>
                        <!-- Full -->
                        <p class="uk-form-controls-condensed" ng-if="widget.data.overlay == 'full'">
                            <label>
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay == 'full'">
                    <label class="uk-form-label" for="wk-animation">{{'Content Animation' | trans}}</label>
                    <div class="uk-form-controls">
                        <select class="uk-form-width-medium" ng-model="widget.data['content_animation']">
                            <option value="fade">{{'Fade' | trans}}</option>
                            <option value="slide-top">{{'Slide Top' | trans}}</option>
                            <option value="slide-bottom">{{'Slide Bottom' | trans}}</option>
                            <option value="slide-left">{{'Slide Left' | trans}}</option>
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay == 'bottom'">
