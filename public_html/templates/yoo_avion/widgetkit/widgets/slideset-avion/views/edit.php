    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-slidenav" class="uk-form-width-medium" ng-model="widget.data['slidenav']">
                            ...
                            <option value="aside">{{'Aside' | trans}}</option>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-delay">{{'Delay (ms)' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-delay" class="uk-form-width-medium" type="text" ng-model="widget.data['delay']">
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.gutter == 'collapse'">
                            <label><input type="checkbox" ng-model="widget.data['grid_divider']"> {{'Grid Divider' | trans}}</label>
                        </p>
                    </div>
                </div>
